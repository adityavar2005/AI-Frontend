  ...
  const renderContent = () => {
    ...
    if (activeMenu === "capture") {
      return (
        ...
        >
          <h3 className="mb-3">📸 Capture Violation</h3>
          <p className="mb-1">Capture feature is under development.</p>
          <p className="text-muted">
            You can still use Manual Add Violation to create challans.
          </p>
        </div>
      );
    }
